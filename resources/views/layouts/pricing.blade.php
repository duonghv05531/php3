   <div class="container-fluid py-5">
       <div class="container">
           <div class="border-start border-5 border-primary ps-5 mb-5" style="max-width: 600px;">
               <h6 class="text-primary text-uppercase">Các gói ưu đãi thành viên</h6>
               <h1 class="display-5 text-uppercase mb-0">Các gói dịch vụ tốt nhất với giá cả cạnh tranh</h1>
           </div>
           <div class="row g-5">
               <div class="col-lg-4">
                   <div class="bg-light text-center pt-5 mt-lg-5">
                       <h2 class="text-uppercase">Basic</h2>
                       <h6 class="text-body mb-5">Lựa chọn phổ biến nhất</h6>
               ...
               <div class="col-lg-4">
                   <div class="bg-light text-center pt-5">
                       ...
                       <h6 class="text-body mb-5">Lựa chọn tốt nhất</h6>
               ...
               <div class="col-lg-4">
                   <div class="bg-light text-center pt-5 mt-lg-5">
                       ...
                       <h6 class="text-body mb-5">Lựa chọn cao cấp nhất</h6>
                       <div class="text-center bg-primary p-4 mb-2">
                           <h1 class="display-4 text-white mb-0">
